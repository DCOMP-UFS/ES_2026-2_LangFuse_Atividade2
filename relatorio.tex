...
\begin{enumerate}[label=\textbf{Acao \arabic*:}]
  ...
  \item \textbf{GRE - Rastreabilidade de requisitos:} mapear requisitos da A1 para issues/PRs, padronizar templates e adicionar links cruzados (issue $\rightarrow$ PR $\rightarrow$ teste).
